          ...
          <div className="settings-card glass-panel" style={{ gridColumn: '1 / -1' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
              <div>
                ...
                <p className="setting-desc" style={{ margin: '4px 0 0 0' }}>Conexão técnica (número vinculado, servidor) é configurada pela equipe do EasyPizza — fale com o suporte pra conectar ou trocar o número.</p>
              </div>
